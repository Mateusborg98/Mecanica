...
import br.com.techchallenge.mecanica.application.usecase.veiculo.*;
...
public class VeiculoController {
    ...
    public ResponseEntity<VeiculoResponse> atualizarIdVeiculoDoVeiculo(@PathVariable UUID id, @RequestBody AtualizarVeiculoRequest request) {
