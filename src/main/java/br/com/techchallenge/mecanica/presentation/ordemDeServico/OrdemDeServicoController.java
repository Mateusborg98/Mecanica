...
public class OrdemDeServicoController {
    ...
    public OrdemDeServicoResponseDto criar(@RequestBody CreateOrdemDeServicoRequestDto request) {
    ...
    public OrdemDeServicoResponseDto negarOrcamento(@PathVariable UUID id) {
    ...
    public OrdemDeServicoResponseDto adicionarServicoPeca(
