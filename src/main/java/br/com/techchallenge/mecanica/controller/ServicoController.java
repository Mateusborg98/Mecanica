...
import br.com.techchallenge.mecanica.dto.servicoDto.TempoMedioServicoResponseDto;
...
public class ServicoController {
    ...
    public ResponseEntity<TempoMedioServicoResponseDto> obterTempoMedio(
            @RequestParam String descricao) {

        Duration tempoMedio = service.calcularTempoMedioPorServico(descricao);

        return ResponseEntity.ok(
                new TempoMedioServicoResponseDto(descricao, tempoMedio));
    }
